...
class DrawerUserControllerSignUP extends StatefulWidget {
  const DrawerUserControllerSignUP({
    Key key,
  ...
  final Function(DrawerIndexSignUp) onDrawerCall;
  ...
  @override
  _DrawerUserControllerSignUPState createState() => _DrawerUserControllerSignUPState();
}

class _DrawerUserControllerSignUPState extends State<DrawerUserControllerSignUP> with TickerProviderStateMixin {
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (BuildContext context, Widget child) {
                    return Transform(
                      ...
                      child: HomeDrawerSignUp(
                        screenIndex: widget.screenIndex == null ? DrawerIndexSignUp.SignIn : widget.screenIndex,
                        iconAnimationController: iconAnimationController,
                        callBackIndex: (DrawerIndexSignUp indexType) {
                          onDrawerClick();
                          try {
